...
export type ReaderLocation = { href: string; cfi: string; sync?: { href: string; locator: { type: 'dom-element'; dom_path: string }; offset: number } };
...
export const EPUBReader = forwardRef<EPUBReaderHandle, { source?: string | Blob; product?: boolean; onLocation?: (location: ReaderLocation) => void; onReady?: () => void }>(function EPUBReader(_, ref) {
