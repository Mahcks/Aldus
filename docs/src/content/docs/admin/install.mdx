...
<Aside type="caution" title="Available with the next release">
  The pinned beta.14 image predates built-in CPU alignment and the CUDA tag. These paths become available with the next tagged Aldus release.
</Aside>
