...
more time; it does not speed up alignment. See [Interrupted alignment jobs](/read-listen/synchronization/#interrupted-alignment-jobs)
for checkpoint and retry behavior.
