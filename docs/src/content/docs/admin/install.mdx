...
| --- | --- | --- |
| `ALDUS_VERSION` | `0.1.0-beta.21` | Exact published image tag to run. Compose stops with an error when this is missing. |
...
`<version>` below with that version, such as `0.1.0-beta.21`.
