...
func TestRouteContract(t *testing.T) {
	...
	want := []string{
		...
		"PUT /activity/{sessionID}", "PUT /alignments/{alignmentID}/progress", "PUT /libraries/{libraryID}/members/{userID}", "PUT /representations/{representationID}/state", "PUT /works/{workID}/progress",
	}
	slices.Sort(got)
	slices.Sort(want)
