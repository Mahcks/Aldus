...
func TestRouteContract(t *testing.T) {
	...
	want = append(
		...
		"POST /acquisition-settings/test",
		"GET /acquisition-capabilities",
		"GET /me/acquisition-tracker",
		"POST /me/acquisition-tracker/seen",
		"GET /libraries/{libraryID}/acquisition-requests",
		"POST /libraries/{libraryID}/acquisition-requests",
		"GET /libraries/{libraryID}/acquisition-requests/{requestID}/search",
		"GET /libraries/{libraryID}/acquisition-requests/{requestID}/search-report",
		"POST /libraries/{libraryID}/acquisition-requests/{requestID}/select",
		"POST /libraries/{libraryID}/acquisition-requests/{requestID}/retry",
		"POST /libraries/{libraryID}/acquisition-requests/{requestID}/cancel",
		"POST /libraries/{libraryID}/acquisition-requests/{requestID}/dismiss",
		"POST /libraries/{libraryID}/acquisition-discoveries",
		"POST /libraries/{libraryID}/acquisition-discoveries/{discoveryID}/select",
		"POST /libraries/{libraryID}/acquisition-discoveries/{discoveryID}/select-pair",
	)
	...
	want = append(want, "GET /request-libraries",
		"GET /search/titles", "GET /discover/trending", "GET /discover/detail")
