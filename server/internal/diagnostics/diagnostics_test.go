...
func TestReportIsAdminOnlyAndChecksRuntimeState(t *testing.T) {
	...
	if report.Version != "v1.2.3" || report.Environment != "test" || report.DatabaseStatus != "ok" || report.StorageStatus != "ok" || report.SchemaVersion != 25 || report.SourceRootsConfigured != 2 || report.SourceRootsReachable != 1 {
